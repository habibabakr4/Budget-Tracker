...
export class ExpensedataService {
  ...
  public ExpenseData: any[] = this.loadExpenses() || [
    {
      expenseTitle: 'Rent',
      expenseAmount: 4000,
  ...
  deleteExpenseData(expenseToDelete: any) {
  
    const index = this.ExpenseData.indexOf(expenseToDelete);
  ...
  private calculateTotalExpense() {
    this.TotalExpense = this.ExpenseData.reduce(
